...
def index_greater_than_last_one(current_list, removed_list):
...
while sequence_of_integers:
    ...
    if index < 0:
        ...
        sequence_of_integers, removed_list = index_greater_than_last_one(sequence_of_integers, removed_list)
    else:
